  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground">Configure your Vexa Dashboard connection</p>
      </div>
      ...
      <div className="max-w-2xl space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>AI settings for meeting transcript analysis. Configure via environment variables.</CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            {isLoadingAIConfig ? (
              ...
              <>
                ...
                <div className="space-y-2">
                  ...
                  <Input value={aiConfig.provider || "Unknown"} disabled className="font-mono bg-muted capitalize" />
                </div>

                {/* Model */}
                <div className="space-y-2">
                  <Label>Model</Label>
                  <Input value={aiConfig.model || "Unknown"} disabled className="font-mono bg-muted" />
                </div>
                ...
                {aiConfig.hasBaseUrl && (
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-2">
                      <Input value="Custom endpoint configured" disabled className="bg-muted" />
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              To configure the dashboard, create a <code className="bg-muted px-1 rounded">.env.local</code> file with
              these variables
            </CardDescription>
          </CardHeader>
          <CardContent>
